...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/stylus-loader/index.js??ref--1-2!./index.styl", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/stylus-loader/index.js??ref--1-2!./index.styl");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( div ) {
			...
			//MONKEY PATCH - removing this line it breaks Opera TV 12
...
// module
exports.push([module.i, "body {\n  font-family: sans-serif;\n  background-color: #000;\n}\n.stat-bar {\n  color: #fff;\n  font-family: \"Source Sans Pro\", Helvetica, sans-serif;\n  position: fixed;\n  background-color: rgba(0,0,0,0.6);\n  transition: height 0.3s ease-in;\n}\n.stat-bar.collapse {\n  height: 0;\n}\n.reveal.default {\n  height: 85vh;\n  position: absolute;\n  padding-top: 15vh;\n}\n.reveal .backgrounds div.feed-splash:before {\n  content: \"\";\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  display: block;\n  position: absolute;\n  background-color: #333;\n  opacity: 0.9;\n}\n.reveal .slides {\n  z-index: 8000 !important;\n}\n.reveal .slides section.feed-splash {\n  color: #fff;\n}\n.reveal .slides section.feed-splash h1,\n.reveal .slides section.feed-splash h4 {\n  color: #fff;\n  max-width: 60%;\n  margin: 0 auto;\n  text-shadow: 0px 2px 2px rgba(0,0,0,0.8);\n  line-height: 1.5em;\n  text-transform: capitalize;\n}\n.reveal .slides section.feed-splash h4 {\n  margin-top: 10px;\n  display: inline-block;\n  font-size: 50%;\n  padding-left: 50px;\n  background-image: url(\"/images/feed.png\");\n  background-position: left;\n  background-size: auto 1em;\n  background-repeat: no-repeat;\n  margin: 0 auto;\n}\n.reveal .slides section.article header.details {\n  text-align: left;\n  font-size: 50%;\n}\n.reveal .slides section.article article {\n  text-align: left;\n}\n.reveal .slides section.article footer {\n  font-size: 50%;\n  text-align: left;\n}\n.reveal .slides section.article footer .page-number .devider:before {\n  content: \"of\";\n}\n.reveal .slides section.feed header.details {\n  text-align: left;\n  font-size: 50%;\n}\n.reveal .slides section.feed article {\n  text-align: left;\n}\n.reveal .slides section.feed footer {\n  font-size: 50%;\n  text-align: left;\n}\n.reveal .slides section.feed footer .page-number .devider:before {\n  content: \"of\";\n}\n.reveal .backgrounds div.slide-background.article.article-content,\n.reveal .backgrounds div.slide-background.feed.feed-content {\n  opacity: 0.1;\n}\n.reveal .backgrounds div.slide-background.feed-splash {\n  background-blend-mode: multiply;\n}\n.reveal .progress {\n  height: 0.5em;\n  position: absolute;\n  bottom: 0;\n  box-shadow: inset 0 1px 2px rgba(0,0,0,0.1);\n}\n.reveal .progress > span {\n  background-color: #009cdf !important;\n  box-shadow: inset 0 -1px 0 rgba(0,0,0,0.15);\n}\n.logo {\n  height: 60%;\n}\n.stat-bar {\n  z-index: 9999;\n  background-repeat: no-repeat;\n  background-size: 100%;\n  width: 100%;\n  top: 0;\n  height: 100px;\n  position: absolute;\n  font-weight: 100;\n  display: table;\n}\n.stat-bar .stat-left {\n  text-align: left;\n  padding-left: 20px;\n}\n.stat-bar .stat-right {\n  text-align: right;\n  padding-right: 20px;\n}\n.stat-bar .stat-left,\n.stat-bar .stat-right {\n  display: table-cell;\n  vertical-align: middle;\n  box-sizing: border-box;\n  width: 50%;\n  height: 100%;\n}\n.stat-bar .location {\n  text-transform: capitalize;\n  margin: 0;\n}\n.overlay {\n  opacity: 0;\n  transition: opacity 0.3s ease-in-out;\n  color: #fff;\n  z-index: 9999;\n  background-color: rgba(0,0,0,0.6);\n  margin: auto;\n  border-radius: 4px;\n  position: absolute;\n  width: 300px;\n  height: 100px;\n  right: 0;\n  bottom: 0;\n  font-size: 3em;\n  text-align: center;\n  display: table;\n}\n.overlay.show {\n  opacity: 1;\n}\n.overlay .loader {\n  display: table-cell;\n  vertical-align: middle;\n  position: relative;\n  height: 80px;\n  text-align: center;\n}\n.overlay .loader span.loader-text:before {\n  display: inline-block;\n  margin-top: 4px;\n  font-family: sans-serif;\n  font-size: 14px;\n  content: \"Loading Content...\";\n}\n.slides .blank h1 {\n  text-transform: capitalize;\n}\n.slide-background.feed.tint {\n  -webkit-box-shadow: inset 0px 0px 0px 9999em rgba(0,0,0,0.75);\n  -moz-box-shadow: inset 0px 0px 0px 9999em rgba(0,0,0,0.75);\n  box-shadow: inset 0px 0px 0px 9999em rgba(0,0,0,0.75);\n}\n.tint {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  height: 100%;\n}\n.tint h1 {\n  text-align: center;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  height: 100%;\n}\n.slides section {\n  font-size: 1.75em;\n}\n", ""]);
